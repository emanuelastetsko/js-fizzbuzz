...
for (let i = 1; i <= 100; i++) {     // Contatore da 1 a 100
    ...
    if (i % 3 == 0 && i % 5 == 0){   // Condizione per i multiplo SIA di 3 SIA di 5 
        ...
        newElement.style.backgroundColor = "#e4bcad";
    }
        ...
        container.append(newElement);
        newElement.style.backgroundColor = "#df979e";
    }
        ...
        container.append(newElement);
        newElement.style.backgroundColor = "#76c8c8";
    }
        ...
        container.append(newElement);
        newElement.style.backgroundColor = "#54bebe";
    }
